...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-12">
            <h2 class="mb-3"><i class="fas fa-tachometer-alt me-2"></i>Dashboard Apoteker</h2>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            <a href="add_medicine.php" class="btn btn-outline-success w-100">
                                <i class="fas fa-plus-circle me-2"></i>Tambah Obat
                            </a>
                        </div>
                        <div class="col-md-3 mb-3">
                            <a href="sales.php" class="btn btn-outline-info w-100">
                                <i class="fas fa-cash-register me-2"></i>Penjualan
                            </a>
                        </div>
                        <div class="col-md-3 mb-3">
                            <a href="search.php" class="btn btn-outline-warning w-100">
